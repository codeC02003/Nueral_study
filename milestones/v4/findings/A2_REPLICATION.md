...
Scored against `PREREGISTRATION_A2.md`, written before A₂ existed.
...
Two, both logged in `PREREGISTRATION_A2.md`, both caught before any metric was
...
Reproduce: `./run_a2_eval.sh` · raw: `findings/layers_a2/L{0,1,2,3}.json`
