...
> budget under random acquisition (`METRICS.md`).
>
...
Reproduce:
```bash
python3 v3_discovery.py --acq random,magnitude,mag90,mag80,mag50   # raw target
python3 v3_discovery.py --acq random,magnitude,mag80 --target log  # the fix
```
