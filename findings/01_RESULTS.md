...
Reproduce: `python3 src/train_b_predict.py` · raw numbers in `findings/predictor.json`
...
Reproduce: `python3 src/ablate.py` · raw numbers in `findings/ablation.json`
...
Reproduce: `python3 src/harvest.py && python3 src/v2_loop.py --budget 600 --step 40`
...
Reproduce: `python3 src/v2_context_loop.py --acq uncert,mixed,topk,random`
...
Reproduce: `python3 src/v2_metric2.py` · raw curves `findings/v2_metric2.json`
