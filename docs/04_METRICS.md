...
Sources: `findings/predictor.json`, `findings/v2_loop.json`, `findings/01_RESULTS.md`
...
completely. Full detail in `findings/02_V3_DISCOVERY.md`:
...
`findings/03_V3_RESOLVED.md`.

**Reproduce everything:**

```bash
python3 src/harvest.py                                        # the 452,219-row dataset
python3 src/v2_loop.py --budget 600 --step 40                 # EXP-1, feature selection
python3 src/v2_context_loop.py --acq uncert,mixed,topk,random # EXP-2, context selection
python3 src/v2_metric2.py                                     # EXP-3, tail-robust
python3 src/v3_discovery.py                                   # V3, mechanism discovery
```

Full narrative including every earlier failure: `02_PROJECT_HISTORY.md`.
Deferred work with trigger conditions: `08_NOT_NOW.md`.
